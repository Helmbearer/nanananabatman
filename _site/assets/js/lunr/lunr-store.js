var store = [{
        ...
        "excerpt":" ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/posts/2019/01/Howto-create-webpages",
        "teaser":null},{
        "title": "My first post",
        "excerpt":"my first post looks just fine. To test the excerpt function I think there has to be a lot of text in this blog post so I will just try to get a lot of words with copying some song lyrics: I’m going to San bernardino ring-a-ding-ding Milkshake mixers that’s...","categories": ["blog"],
        "tags": [],
